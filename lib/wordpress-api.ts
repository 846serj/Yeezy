...
export class WordPressAPI {
  ...
  async getPosts(params: {
    ...
    // If no status is specified, include both published and draft posts
    const queryParams = {
      per_page: 10,
      page: 1,
      _embed: true,
...
export const createWordPressAPI = (siteUrl: string, username: string, appPassword: string): WordPressAPI => {
