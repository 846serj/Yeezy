...
const SimpleImageToolbar: React.FC<SimpleImageToolbarProps> = ({ isVisible, position, onClose, onDelete, onReplace }) => {
  ...
  return createPortal(
    <div
      ...
      style={{
        position: 'fixed',
        top: position.y - 60, // Position 60px above the image
        left: position.x - 150, // Center the toolbar (300px width / 2)
        zIndex: 1000000,
        pointerEvents: 'auto',
    ...
    >
      <div className="image-toolbar">
        <button className="toolbar-btn" title="Align">
        ...
        <button className="toolbar-btn" title="Options">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
